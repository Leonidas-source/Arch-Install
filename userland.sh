...
function plasma {
	clear
	pacman -S plasma-meta konsole dolphin kate spectacle plasma-wayland-session gwenview ark p7zip unrar unarchiver lzop lrzip okular filelight networkmanager kolourpaint
