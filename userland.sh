...
function plasma {
	clear
	pacman -S plasma konsole dolphin kwrite spectacle plasma-wayland-session gwenview ark p7zip unrar unarchiver lzop lrzip okular filelight networkmanager flatpak
