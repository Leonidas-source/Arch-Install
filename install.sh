...
function install_base_system {
	...
	read kernel
	[ "$kernel" == "1" ] && pacstrap -K /mnt base linux linux-firmware dhcpcd nano gvim mc exfat-utils btrfs-progs ntfs-3g htop dosfstools && touch LINUX
	[ "$kernel" == "2" ] && pacstrap -K /mnt base linux-hardened linux-firmware dhcpcd nano gvim mc exfat-utils btrfs-progs ntfs-3g htop dosfstools && touch HARD
	[ "$kernel" == "3" ] && pacstrap -K /mnt base linux-lts linux-firmware dhcpcd nano gvim mc exfat-utils btrfs-progs ntfs-3g htop dosfstools && touch LTS
	[ "$kernel" == "4" ] && pacstrap -K /mnt base linux-zen linux-firmware dhcpcd nano gvim mc exfat-utils btrfs-progs ntfs-3g htop dosfstools && touch ZEN
}
function copy_files {
